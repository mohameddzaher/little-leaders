...
export default function TeamSliderEnglish({ teamMembers }: Props) {
  return (
    <div className="relative overflow-hidden group">
      <div className="team-slider-en">
        {/* First set */}
              ...
              <div className="p-3 flex flex-col flex-1">
                ...
                <div className="space-y-0.5 mb-1.5">
                  <p className="text-royal-blue/70 text-[10px] text-center">
                    <span className="font-semibold">Experience:</span> {member.experienceEn}
                  </p>
                  <p className="text-royal-blue/70 text-[10px] text-center line-clamp-1">
                    <span className="font-semibold">Qualification:</span> {member.qualificationEn}
                  </p>
                </div>
      ...
      <style jsx>{`
        .team-slider-en {
          ...
          gap: 1.5rem;
          width: max-content;
          animation: scrollEnglish 50s linear infinite;
        }
