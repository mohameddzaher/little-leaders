  ...
  const content = {
    ar: {
      ...
      values: {
        ...
        subtitle: "القيم والمبادئ التي نؤمن بها ونسعى لترسيخها في أطفالنا",
        items: [
          {
    ...
    <div>
      ...
      <section className="pt-20 pb-8 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-light-blue/10 via-white to-pink/10 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "url(/images/Facilities/8-1.webp)",
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <h2
                className={`text-2xl font-bold text-royal-blue mb-4 ${
              ...
              <p
                className={`text-royal-blue/70 leading-relaxed ${
                  language === "ar" ? "text-justify" : "text-justify"
                } ${language === "ar" ? "text-right" : "text-left"}`}
              >
                {current.hero.description}
              </p>
